...
def KinLayer(wristBase,fingerVectors,jointAngles,boneLengths,fingerAngles):
    ...
    # THUMB
    T_MCP = ROT_X(math.pi,0,0,0) + fingerVectors[0:3]
    T_MCP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],T_MCP[0],T_MCP[1],T_MCP[2])
    ...
    T_PIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],T_PIP[0],T_PIP[1],T_PIP[2])
    ...
    T_DIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],T_DIP[0],T_DIP[1],T_DIP[2])
    ...
    T_TIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],T_TIP[0],T_TIP[1],T_TIP[2])

    # INDEX
    I_MCP = ROT_Z(fingerAngles[0]+fingerAnglesMean[0],0,0,0) + fingerVectors[3:6]
    I_MCP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],I_MCP[0],I_MCP[1],I_MCP[2])
    ...
    I_PIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],I_PIP[0],I_PIP[1],I_PIP[2])
    ...
    I_DIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],I_DIP[0],I_DIP[1],I_DIP[2])
    ...
    I_TIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],I_TIP[0],I_TIP[1],I_TIP[2])

    # MIDDLE
    M_MCP = ROT_Z(fingerAngles[1]+fingerAnglesMean[1],0,0,0) + fingerVectors[6:9]
    M_MCP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],M_MCP[0],M_MCP[1],M_MCP[2])
    ...
    M_PIP = ROT_Z(fingerAngles[1]+fingerAnglesMean[1],M_PIP[0],M_PIP[1],M_PIP[2]) + fingerVectors[6:9]
    M_PIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],M_PIP[0],M_PIP[1],M_PIP[2])
    ...
    M_DIP = ROT_Z(fingerAngles[1]+fingerAnglesMean[1],M_DIP[0],M_DIP[1],M_DIP[2]) + fingerVectors[6:9]
    M_DIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],M_DIP[0],M_DIP[1],M_DIP[2])
    ...
    M_TIP = ROT_Z(fingerAngles[1]+fingerAnglesMean[1],M_TIP[0],M_TIP[1],M_TIP[2]) + fingerVectors[6:9]
    M_TIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],M_TIP[0],M_TIP[1],M_TIP[2])

    # RING
    R_MCP = ROT_Z(fingerAngles[2]+fingerAnglesMean[2],0,0,0) + fingerVectors[9:12]
    R_MCP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],R_MCP[0],R_MCP[1],R_MCP[2])
    ...
    R_PIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],R_PIP[0],R_PIP[1],R_PIP[2])
    ...
    R_DIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],R_DIP[0],R_DIP[1],R_DIP[2])
    ...
    R_TIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],R_TIP[0],R_TIP[1],R_TIP[2])

    # PINKY
    P_MCP = ROT_Z(fingerAngles[3]+fingerAnglesMean[3],0,0,0) + fingerVectors[12:15]
    P_MCP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],P_MCP[0],P_MCP[1],P_MCP[2])
    ...
    P_PIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],P_PIP[0],P_PIP[1],P_PIP[2])
    ...
    P_DIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],P_DIP[0],P_DIP[1],P_DIP[2])
    ...
    P_TIP = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2],P_TIP[0],P_TIP[1],P_TIP[2])
