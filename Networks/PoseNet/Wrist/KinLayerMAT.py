...
def KinLayer(input):
    ...
    # WRIST BASE JOINT
    WRIST = wristBase[0:3]
    MAT_WRIST = HOM_TRANS(wristBase[5],wristBase[4],wristBase[3],wristBase[0],wristBase[1],wristBase[2])

    # THUMB
    MAT_T_MCP = tf.matmul(MAT_WRIST,TRANSL(fingerVectors[0],fingerVectors[1],fingerVectors[2]))
    ...
    # INDEX
    MAT_I_MCP = tf.matmul(MAT_WRIST,TRANSL(fingerVectors[3],fingerVectors[4],fingerVectors[5]))
    ...
    # MIDDLE
    MAT_M_MCP = tf.matmul(MAT_WRIST,TRANSL(fingerVectors[6],fingerVectors[7],fingerVectors[8]))
    MAT_M_MCP = tf.matmul(MAT_M_MCP,ROT_Z(fingerAnglesMean[1]))
    ...
    # RING
    MAT_R_MCP = tf.matmul(MAT_WRIST,TRANSL(fingerVectors[9],fingerVectors[10],fingerVectors[11]))
    ...
    # PINKY
    MAT_P_MCP = tf.matmul(MAT_WRIST,TRANSL(fingerVectors[12],fingerVectors[13],fingerVectors[14]))
