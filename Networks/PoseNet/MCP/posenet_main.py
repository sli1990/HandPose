...
def run_posenet():
	...
	pose3D_est, mcpBase_est, fingerVectors_est, jointAngles_est, boneLengths_est, poseDirect_est = PoseNet(next_images, next_joints, next_scales)

	# Add the operations for loss calculation to the graph
	eval_op = loss_boxnet(pose3D_est, mcpBase_est, fingerVectors_est, jointAngles_est, boneLengths_est, poseDirect_est, next_joints)
